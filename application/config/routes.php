...
$route['admin/gallery/get-all'] = 'Gallery_Controller/get';
$route['admin/gallery/edit/(:num)'] = 'Gallery_Controller/update/$1';
$route['admin/gallery/add'] = 'Gallery_Controller/store';
$route['admin/gallery/delete-image'] = 'Gallery_Controller/delete_image';
$route['admin/gallery/delete'] = 'Gallery_Controller/delete';
