        ...
        <div class="box">
            ...
            <form class="form-horizontal" method="POST" ng-submit="addGallery()" ng-show="showform" name="addform" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="name" ng-model="newgallery.name"/>
                    </div>
                            ...
                            <div class="thumbnail" ng-mouseover="showcaption=true" ng-mouseleave="showcaption=false">
                                <div class="caption" ng-show="showcaption">
                                    <div id="content">
                                        ...
                                        <a href="" class="label label-danger" rel="tooltip" title="Delete" ng-click="deleteImage(preview)">Delete</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3" dir-paginate="gallery in galleries | filter:serach | limitTo:pageSize | itemsPerPage:numPerPage">
                    <div class="cuadro_intro_hover thumbnail" style="background-color:#cccccc;">
                        <p style="text-align:center;">
                            <img class="img-responsive" style="cursor:pointer;" src="{{public_url + '/uploads/' + gallery.files[0].file_name}}" alt="{{gallery.name}}" />
                        </p>
                        <div class="caption">
                            <div class="blur"></div>
                            <div class="caption-text">
                                ...
                                <button type="button" style="color: initial;" class="btn btn-default" ng-click="deleteGallery(gallery)">delete</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-2" ng-repeat="file in galleryfiles.files">
                                    <div class="thumbnail img-responsive">
                                        <a href="{{public_url + '/uploads/' + file.file_name}}">
                                            <img src="{{public_url + '/uploads/' + file.file_name}}" alt="{{file.file_name}}"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
